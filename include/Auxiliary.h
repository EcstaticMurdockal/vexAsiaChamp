...
inline void check()
{
  ...
  // if(!Roller_Motor_Up1.installed()){
  //   error++;
  //   // Controller1.Screen.print("Tr ");
  //   Controller1.Screen.print("Roller_Motor not installed\n ");
  // }
  // if(!Roller_Motor_Down.installed()){
  //   error++;
  //   // Controller1.Screen.print("Tr ");
  //   Controller1.Screen.print("Hang_Motor not installed\n ");
  // }
...
inline void init()
{
    ...
    {
      thread([]{
          Inertial_1.resetHeading();
          Inertial_2.resetHeading();
          wait(2,sec);
          Controller1.rumble(".");
      });
    }
